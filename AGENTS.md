...
Shared rules for every agentic coding tool working in VibeCity. Claude Code, Codex, Cursor, and any future agent: this file is mandatory reading before you write anything.

Project pitch: A fully vibed city builder that you can actually drive around in.
...
The Game Design Document at `docs/gdd/` is the source of truth for what VibeCity is. Before proposing architecture, adding features, or changing data schemas, read it. If the GDD and your idea disagree, the GDD wins unless explicitly approved.
...
Next.js 15 (App Router) + React 19 + TypeScript 5; raw three (no R3F); custom math-based physics; Web Audio; @upstash/redis; zod; Vitest + Playwright
